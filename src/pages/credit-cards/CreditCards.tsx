      ...
      <div className="flex flex-wrap gap-2.5">
        <div className="flex-grow shrink-0 md:max-w-full w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 overflow-hidden w-full mt-2.5">
            <div className="before:bg-white/20 border flex-grow shrink-0 relative p-3.5 font-lato before:absolute before:content-[' '] before:bottom-0 before:h-12 xl:before:h-14 before:left-0 before:right-0 rounded-2xl space-y-4 lg:space-y-2 xl:space-y-6 flex-grow w-full bg-gradient-to-br from-[#2D60FF] to-[#539BFF] text-white">
            ...
            <div className="border flex-grow shrink-0 relative p-3.5 font-lato before:absolute before:content-[' '] before:bottom-0 before:h-12 xl:before:h-14 before:border-t before:left-0 before:right-0 rounded-2xl space-y-4 lg:space-y-2 xl:space-y-6 flex-grow w-full bg-white">
              <div className="flex items-start justify-between">
                <div className="flex flex-col items-start">
                  <span className="text-xs font-normal">Balance</span>
                  <span className="text-sm font-semibold">$5,764</span>
        ...
        <div className="flex-grow w-full lg:w-fit shrink-0">
          ...
          <ul className="space-y-2">
            <li className="py-2.5 px-3 rounded-2xl bg-white flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-[#718EBF] font-normal">Secondary</span>
                </div>
              </div>
            ...
            <li className="py-2.5 px-3 rounded-2xl bg-white flex justify-between items-center">
              <div className="flex items-center gap-2">
                <span className="h-10 w-10 rounded-xl flex items-center justify-center bg-[#FFE0EB]">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
            ...
            <li className="py-2.5 px-3 rounded-2xl bg-white flex justify-between items-center">
              <div className="flex items-center gap-2">
                <span className="h-10 w-10 rounded-xl flex items-center justify-center bg-[#FFF5D9]">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                  ...
                  >
                    <g clipPath="url(#clip0_196_542)">
                      ...
                      />
                      <path
                        d="M20 12.8471C20 10.5293 18.1211 8.65039 15.8033 8.65039C13.4855 8.65039 11.6066 10.5293 11.6066 12.8471C11.6066 15.1648 13.4855 17.0438 15.8033 17.0438C18.1211 17.0438 20 15.1648 20 12.8471ZM16.369 15.0891V15.566H15.783V15.566V15.566H15.1971V15.0926C14.8429 14.9726 14.553 14.7616 14.27 14.5546L14.9618 13.6087C15.342 13.8868 15.5366 14.0205 15.8033 14.0205C15.9541 14.0205 16.0761 13.9487 16.1219 13.8332C16.1773 13.6934 16.099 13.5645 15.9124 13.4886C15.9124 13.4886 15.0748 13.2092 14.6876 12.8144C14.3627 12.4832 14.2594 12.0164 14.3628 11.5724C14.467 11.1254 14.7688 10.7758 15.1971 10.6012V10.1281H16.369V10.5816C16.6666 10.6643 16.9185 10.7864 17.0634 10.865L16.5043 11.8949C16.1336 11.6937 15.7925 11.6333 15.6598 11.6787C15.531 11.7227 15.5114 11.8067 15.5041 11.8383C15.4936 11.8831 15.488 11.9519 15.5597 12.0317C15.6286 12.1086 16.3542 12.4032 16.3542 12.4032C17.1371 12.7219 17.5055 13.5223 17.2113 14.2649C17.0585 14.6509 16.7508 14.9432 16.369 15.0891Z"
                        fill="#FFBB38"
                      />
                    </g>
                    <defs>
