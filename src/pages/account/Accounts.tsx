...
export const Accounts = () => {
  return (
    <div className="px-2 w-full mt-28 lg:px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-y-8 lg:max-w-6xl xl:max-w-7xl lg:mx-auto">
      <div className="grid xs:grid-cols-2 sm:grid-cols-2 lg:!grid-cols-4 gap-3 col-span-full">
        <div className="bg-white rounded-2xl border h-24 p-6 lg:p-3 flex items-center lg:h-[5.5rem] xl:h-28 sm:col-span-1 gap-4 w-full">
      ...
      {/* last transaction */}
      <div className="mt-4 sm:mt-0 lg:col-span-2">
        <h3 className="text-base lg:text-xl font-bold text-affiliate-blue capitalize">
          last transactions
        </h3>

        <div className="bg-white rounded-xl p-4 space-y-2 mt-2">
      ...
      <div className="mt-4 sm:mt-0">
        <nav className="flex justify-between items-center">
          <h3 className="text-base font-bold text-affiliate-blue lg:text-xl">My Cards</h3>
          <button className="text-base px-2 py-1.5 font-medium text-affiliate-blue capitalize lg:text-lg">
            See All
          </button>
        </nav>
        <div className="overflow-hidden mt-3 sm:mt-0 w-full">
          <div className="relative before:absolute before:content-[' '] before:bottom-0 before:h-16 before:bg-white/20 before:left-0 before:right-0 p-4 rounded-xl flex-none space-y-3 flex-grow-0 w-full bg-gradient-to-br from-[#2D60FF] to-[#539BFF] text-white">
          
            <div className="flex items-start justify-between">
              <div className="flex flex-col">
                <p className="font-light">Balance</p>
                <p className="text-lg">$5,764</p>
              </div>
            ...
            <div className="pb-4 flex w-full items-center justify-between">
              <div>
                <h2 className="">card holder</h2>
                <p className="">Eddy Cusuma</p>
              </div>

              <div>
                <h2 className="">valid thru</h2>
                <p className="">12/12</p>
              </div>
            </div>
            <div className="flex  w-full items-center justify-between">
              <p className="">3778 **** **** 1234 </p>
              <CardTypeIcon />
            </div>
          </div>
        </div>
      ...
      <div className="mt-4 sm:mt-0 lg:col-span-2">
        ...
        <div className="mt-2 w-full bg-white rounded-xl p-8 h-44 md:h-[17rem]"></div>
      </div>
